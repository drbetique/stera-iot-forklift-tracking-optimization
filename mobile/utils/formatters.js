/**
 * Utility functions for formatting data in the Stera IoT Mobile App
 * Adapted from the web dashboard for React Native
 */
...
export const getBatteryColor = (level) => {
  ...
  if (level >= 40) return '#f59e0b'; // Yellow/Orange
  return '#ef4444'; // Red
};
